...
namespace MovieRenamer
{
	...
	public class Parser
	{
		...
		private ProgressBar outprog = null;
		...
		public Parser(String path)
		{
			...
			moviesPath = path;
			#if _HAS_FORM
			output = mainForm.instance.fileList;
			outprog = mainForm.instance.scanProgress;
			#endif
		}
		...
		private void scanFolder(String folder)
		{
			...
			outprog.Maximum = elements.Length;
			outprog.Value = 0;
			outprog.Show();
		...
		private void writeMovie(Movie m)
		{
			output.Items.Add(m);
		}
